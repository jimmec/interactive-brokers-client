...
public class ApiDemo implements IConnectionHandler {
	...
	private final Semaphore downloadRequestMutex;
	...
	private final MarketDataPanel m_mktDataPanel;
	...
	public ApiDemo( IConnectionConfiguration connectionConfig ) {
		downloadRequestMutex = new Semaphore(1, true);
		m_mktDataPanel = new MarketDataPanel(downloadRequestMutex, m_outLogger);
